...
export type NativeVideoComponentType = HostComponent<VideoNativeProps>;

export default codegenNativeComponent<VideoNativeProps>('RNCVideo') as NativeVideoComponentType;
